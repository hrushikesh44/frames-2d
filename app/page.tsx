        ...
        <div className="flex flex-col items-center justify-center relative">
            ...
            id="main" className="fixed top-0 z-50 backdrop-blur-3xl flex items-center justify-around w-full px-5 py-3 h-16">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Link href={'/login'} className="px-2 py-1 text-white bg-[#fe7787] rounded-lg shadow-lg">Login</Link>
                    <ThemeToggle />
                </div>
            </motion.section>
            <motion.section 
            ...
            id="video-section" className="flex flex-col items-center mt-40">
                ...
                <Link href={'/generate'} className="flex group border border-neutral-400/40 shadow-lg px-4 py-1 rounded-md hover:bg-[#fe7877] hover:text-white" type="button">Get Started <IconArrowRight className="group-hover:translate-x-1 transition-transform duration-200"/></Link>
            ...
            animate={{ opacity: 1}}
            transition={{ duration: 0.5, ease: "easeInOut"}}
            id="feature-section" className="mt-20 flex flex-col items-center mb-20">
                <Bento/>
                <div className="mt-40 h-72 md:w-4xl w-full rounded-lg border border-neutral-400/30 shadow-lg flex items-center justify-around">
                    <div className="p-12 w-1/2">
                        ...
                        <Link href={'/generate'} className="flex group rounded-lg px-4 py-2 items-center justify-center text-white mt-4 bg-[#fe7787]">Start now{' '} <IconArrowRight className="group-hover:translate-x-1 transition-transform duration-200"/></Link>
                    </div>
                    <div>
                        <ClipIcon />
                    </div>
